...
/**
 * Test-specific implementation of TaskEventService that uses TestTaskEventCommandFactory.
...
public class TestTaskEventService {
    ...
    private final TestTaskEventCommandFactory commandFactory;
     ...
     */
    public TestTaskEventService(TaskEventRepository taskEventRepository,
                            UserService userService,
                            TestTaskEventCommandFactory commandFactory,
